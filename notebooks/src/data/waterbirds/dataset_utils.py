# taken from https://github.com/kohpangwei/group_DRO/tree/master/dataset_scripts
...
def crop_and_resize(source_img, target_img):
    ...
    # print (f'Before: ({source_width}, {source_height})')
    ...
    # print (f'After: ({source_resized.size[0]}, {source_resized.size[1]})')

    return source_resized


def combine_and_mask(img_new, mask, img_black, resize=True):
    """
    ...
    img_resized = crop_and_resize(img_new, img_black) if resize else img_new
